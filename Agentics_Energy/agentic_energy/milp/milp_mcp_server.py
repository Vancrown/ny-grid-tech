...
def milp_solve(solverequest: SolveRequest) -> SolveResponse:
    ...
    return solve_daily_milp(
        solverequest.battery,
        solverequest.day,
        solverequest.solver,
        solverequest.solver_opts,
    )


@mcp.tool()
def milp_solve_from_records(
    solverecordrequest: SolveFromRecordsRequest,
) -> SolveResponse:
    ...
    return solve_daily_milp(
        solverecordrequest.battery,
        day,
        solverecordrequest.solver,
        solverecordrequest.solver_opts,
    )
